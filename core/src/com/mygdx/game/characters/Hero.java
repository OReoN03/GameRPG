...
public class Hero extends GameCharacter {
    ...
    private int level;
    private int exp;
    private int[] expTo = {0, 0, 100, 300, 600, 1000, 2500};
    ...
    public void update(float dt) {
        ...
        direction.set(0, 0);
        if (Gdx.input.isKeyPressed(Input.Keys.RIGHT)) direction.x = 1.0f;
        if (Gdx.input.isKeyPressed(Input.Keys.LEFT)) direction.x = -1.0f;
        if (Gdx.input.isKeyPressed(Input.Keys.UP)) direction.y = 1.0f;
        if (Gdx.input.isKeyPressed(Input.Keys.DOWN)) direction.y = -1.0f;
