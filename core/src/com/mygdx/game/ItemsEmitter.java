...
public class ItemsEmitter {
    ...
    public ItemsEmitter() {
        ...
        this.texture = new Texture("Items.png");
        this.regions = new TextureRegion(texture).split(32, 32)[0];
    }
    ...
    public void generateRandomItem(float x, float y, int count, float provability) {
